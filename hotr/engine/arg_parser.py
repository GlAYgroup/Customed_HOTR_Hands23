...
def get_args_parser():
    ...
    # Hand pose
    parser.add_argument('--hand_pose', default='None', type=str)

    # Task(AOD(Active object detection), ASOD(Active Secong Object Detection))
    parser.add_argument('--task', default='AOD', type=str)

    # Visialization Method
    parser.add_argument('--vis_mode', default='all', type=str)
    ...
    ## for ASOD
    parser.add_argument('--set_cost_soidx', default=1, type=float,
                    help="Second Object index coefficient in the matching cost") # handとobjectの係数となるset_cost_idxとは別に、second-objectの係数を独立的に設定
    ...
    ## for ASOD
    parser.add_argument('--hoi_soidx_loss_coef', default=1, type=float, help="Loss coefficient for Second Object index") # handとobjectの係数となるhoi_idx_loss_coefとは別に、second-objectの係数を独立的に設定
    ...
    parser.add_argument('--hand_threshold', type=float, default=0, help='Threshold for hand confidence')
    parser.add_argument('--second_object_threshold', type=float, default=0, help='Threshold for second object confidence')
    ...
    parser.add_argument('--vis', action='store_true', help="Visualize the results if the flag is provided")
