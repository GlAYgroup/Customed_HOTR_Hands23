...
from hotr.data.datasets.doh import build as build_doh
from hotr.data.datasets.hands23 import build as build_hands23
...
def build_dataset(image_set, args):
    if args.dataset_file == 'coco':
        ...
        return build_doh(image_set, args)
    elif args.dataset_file == 'hands23':
        return build_hands23(image_set, args)
