...
class VCocoDetection(Dataset):
    def __init__(self,
        ...
        # print("coco_classes", self.COCO_CLASSES)
    ...
    def save_action_name(self):
        ...
        for vcoco in self.vcoco_all:
            if len(vcoco['role_name']) == 3:
                ...
                print("vcoco['role_name']", vcoco['role_name'])
        ...
        # print("self.inst_act_list", self.inst_act_list)
        # print("self.act_list", self.act_list)    
    ...
    def prepare_img(self, idx):
        ...
        print("/large/maeda/HOTR/hotr/data/datasets/vcoco.py", img_info['file_name'])
    ...
    def __getitem__(self, idx):
        ...
        # print("/large/maeda/HOTR/hotr/data/datasets/vcoco.py target: ", target)
        return img, target
