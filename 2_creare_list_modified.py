...
print("AP_HO:", ap_ho_results)
print("AP_HOS:", ap_hos_results)
print("AP_HAND:", ap_hand_results)
print("AP_ACTIVE_OBJ:", ap_active_obj_results)
print("AP_SECOND_OBJ:", ap_second_obj_results)
